...
*/
const $ = new Env('陌嗨短视频');
let mhurl4 = $.getdata('mhurl4')
let mhhd4 = $.getdata('mhhd4')
let mhbody4 = $.getdata('mhbody4')
...
function mhck() {
  ...
  $.setdata(JSON.stringify($request.url),'mhurl4')
    $.log(mhurl4)
    $.setdata(JSON.stringify($request.headers),'mhhd4')
$.log(mhhd4)
    $.setdata($request.body,'mhbody4')
$.log(mhbody4)
...
let url = {
        ...
        headers : JSON.parse($.getdata('mhhd4')),
        body : `{
  "type": 1,
  "taskId": 0
}`,}
