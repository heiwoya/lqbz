...
*/
const $ = new Env('羊毛赚');
let ymzurl3 = $.getdata('ymzurl3')
let ymzhd3 = $.getdata('ymzhd3')
let ymzbody7 = $.getdata('ymzbody7')
let ymzbody8 = $.getdata('ymzbody8')
let ymztxbody3 = $.getdata('ymztxbody3')
!(async () => {
...
function ymzqd(timeout = 0) {
  return new Promise((resolve) => {
    setTimeout( ()=>{
      if (typeof $.getdata('ymzbody7') === "undefined"||typeof $.getdata('ymzbody8') === "undefined") {
